...
import com.spendesk.grapes.samples.databinding.ViewColorListBinding
...
class ColorSampleListItemView : ConstraintLayout {
    ...
    private val binding = ViewColorListBinding.inflate(LayoutInflater.from(context), this, true)
