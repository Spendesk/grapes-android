...
class ColorsAdapter : RecyclerView.Adapter<ColorsAdapter.CoverViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CoverViewHolder {
        ...
        return when (ColorsBlockViewType.values()[viewType]) {
            ...
            ColorsBlockViewType.COVER_LIST -> CoverViewHolder.CoverList(ColorSampleListItemView(context))
        }.apply {
    ...
    override fun onBindViewHolder(holder: CoverViewHolder, position: Int) {
        when (holder) {
            ...
            is CoverViewHolder.CoverList -> holder.view.updateConfiguration(ColorSampleListItemView.Configuration((listItems[position] as ColorsBlockModel.Cover).configuration.items))
        }
    }
